...
public:
	...
	static PhyObjPrimitiveRef createStaticPlane( const ci::Vec3f &normal, btScalar offset, const ci::Vec3f &initialPosition, const ci::Quatf &initialRotation = ci::Quatf::identity() );
